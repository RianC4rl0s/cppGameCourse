...
void FontDemo::Init()
{
    ...
    inkFree = new Font("Resources/ink-free44.png");
    inkFree->Spacing("Resources/ink-free44.dat");
}
...
void FontDemo::Draw()
{
    ...
    verdana->Draw(60, 345, "Verdana 12", green,Layer::FRONT, 0.75f,-30);
    verdana->Draw(100, 375, "Esta é a fonte Verdana 12 pontos", blue, Layer::FRONT, 1.0f,-45);
    verdana->Draw(140, 405, "ABCDEFGHIJKLMNOPQRSTUVWXYZ0123456789", red, Layer::FRONT, 1.25f,-60);
    verdana->Draw(200, 435, "abcdefghijklmnopqrstuvwxyz!@#$%&*(+^~çáêôüã", Color(0.1f,0.40f,0.70f,1.0f), Layer::FRONT, 1.50f,-90);

    inkFree->Draw(150, 350, "Font Demo", red, Layer::UPPER,1.5f,-45);
} 
